...
if instrument:
  ...
  while (1):
    ...
    print '%s -- PV: %5.2f V %4.2f A %6.2f W -- Battery: %5.2f V %4.2f A %6.2f W %.0f %s' % (t, pv_voltage, pv_current, pv_voltage * pv_current, batt_voltage, batt_current_l, batt_voltage * batt_current_l, 100 * batt_soc, '%')
